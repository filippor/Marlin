...
#define DEFAULT_bedKp 297.38
#define DEFAULT_bedKi 57.62
#define DEFAULT_bedKd 1023.19
...
//    #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET))          // (mm) Get this value from G33 auto calibrate
  ...
  #define DELTA_HEIGHT 287.31             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -2.870, 0.0, -0.875 } // Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.474241, 0.395318, 0.0 } // Get these values from G33 auto calibrate

  // Delta radius and diagonal rod adjustments (mm)
  //#define DELTA_RADIUS_TRIM_TOWER { 0.0, 0.0, 0.0 }
//  #define DELTA_DIAGONAL_ROD_TRIM_TOWER { -2.776934, -1.724641, 0.0 }
...
#define Z_SERVO_ANGLES { 155, 10 } // Z Servo Deploy and Stow angles
...
//#endif
#define NOZZLE_TO_PROBE_OFFSET { -4, -0.7, -7.30}
